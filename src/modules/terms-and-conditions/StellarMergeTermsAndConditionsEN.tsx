      ...
      <TermsAndConditionsContent>
        ...
        <PolicySection>
          ...
          <Text>
            ...
            indirect, or consequential damages whatsoever, even if the Company
        ...
        <PolicySection>
          ...
          <Text>
            ...
            the Service; (ii) that the Service will be uninterrupted or
            error-free; (iii) as to the accuracy, reliability, or currency of
            any information or content provided through the Service.
          </Text>
        </PolicySection>
        ...
        <PolicySection>
          <PolicySectionHeader>
            ...
            <TextSubtitle>Governing Law and Disputes</TextSubtitle>
          </PolicySectionHeader>
          <Text>
        ...
        <PolicySection>
          <PolicySectionHeader>
            ...
            <TextSubtitle>Compliance and Severability</TextSubtitle>
          </PolicySectionHeader>
          <Text>
          ...
          <Text>
            ...
            that is subject to the United States government embargo, and (ii)
