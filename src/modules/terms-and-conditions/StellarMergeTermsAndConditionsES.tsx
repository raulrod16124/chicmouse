      ...
      <TermsAndConditionsContent>
        ...
        <PolicySection>
          ...
          <Text>
            ...
            significados definido bajo las siguientes condiciones. Las
          ...
          <TextList>
            <li>
              <Text>
                ...
                dispositivo electrónico, llamado Stellar Merge
              </Text>
            </li>
            <li>
              <Text>
                <strong>Tienda de Aplicaciones</strong> significa la
                distribución digital servicio operado y desarrollado por Apple
                Inc. (Apple App Store) o Google Inc. (Google Play Store) en la
                que la Aplicación ha sido descargado.
              </Text>
            </li>
            <li>
              <Text>
            ...
            <li>
              <Text>
                ...
                forman el acuerdo completo entre usted y la Compañía respecto al
                uso del servicio.
              </Text>
            </li>
            <li>
              <Text>
                ...
                significa cualquier servicios o contenidos proporcionados por un
                tercero que pueden mostrarse, incluidos o puestos a disposición
                por el Servicio.
              </Text>
            </li>
            <li>
        ...
        <PolicySection>
          ...
          <Text>
            ...
            todos los usuarios respecto al uso del Servicio.
          </Text>
          <Text>
            Su acceso y uso del Servicio está condicionado a Su aceptación y
            cumplimiento de estos Términos y Condiciones. Al acceder o utilizar
            el Servicio, usted acepta estar sujeto a estos Términos y
            condiciones.
          </Text>
          <Text>
            Su acceso y uso del Servicio también está condicionado a Su
            aceptación y cumplimiento de la Política de Privacidad de la
            Empresa. Por favor lea nuestra política de privacidad cuidadosamente
        ...
        <PolicySection>
          ...
          <Text>
            ...
            términos y condiciones y la política de privacidad de cualquier
        ...
        <PolicySection>
          ...
          <Text>
            ...
            aviso o responsabilidad, por cualquier motivo, incluso sin
        ...
        <PolicySection>
          ...
          <Text>
            ...
            cualquier disposición de estos Términos será limitado al monto
            realmente pagado por usted a través del Servicio o 100 USD si no has
            comprado nada a través del Servicio.
          </Text>
          <Text>
            En la medida máxima permitida por la ley aplicable, en ningún caso
            la Compañía o sus proveedores serán responsables de cualquier daño
            especial, incidental, daños indirectos o consecuentes de cualquier
            tipo, incluso si la Compañía ha sido advertida de la posibilidad de
            tales daños.
          </Text>
        </PolicySection>
        ...
        <PolicySection>
          ...
          <Text>
            ...
            DISPONIBILIDAD&quot; y con todas las fallas y defectos sin garantía
            de ningún tipo. En la medida máxima permitida por la ley aplicable,
            la Compañía renuncia expresamente a todas las garantías, ya sean
            expresas, implícitas, legales o de otro tipo.
          </Text>
        </PolicySection>
        ...
        <PolicySection>
          ...
          <Text>
            Usted declara y garantiza que no se encuentra en un país que esté
            sujeto al embargo del gobierno de los Estados Unidos, o que haya
            sido designado como un país que &quot;apoya al terrorismo&quot;.
          </Text>
          <Text>
