...
export const MatchupPrivacyPolicyEN = () => {
  return (
    <PrivacyPolicyWrapper data-testid="matchup-privacy-policy-en-page-id">
      <PrivacyPolicyContent>
        ...
        <TextList>
          ...
          <li>
            <Text>
              <strong>Application</strong> refers to matchup, the software
