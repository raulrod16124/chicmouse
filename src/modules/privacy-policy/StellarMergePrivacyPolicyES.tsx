  ...
  return (
    <PrivacyPolicyWrapper data-testid="stellar-merge-privacy-policy-es-page-id">
      <PolicyHero>
        ...
        <PolicyHeroTitle>Política de privacidad</PolicyHeroTitle>
        <PolicyHeroMeta>
      ...
      <PrivacyPolicyContent>
        ...
        <PolicySection>
          ...
          <Text>Para los efectos de esta Política de Privacidad:</Text>
          <TextList>
            <li>
              <Text>
            ...
            <li>
              <Text>
                <strong>Aplicación</strong> se refiere a Stellar Merge, el
                programa de software proporcionado por la Compañía.
              </Text>
            </li>
            <li>
              <Text>
                <strong>Compañía</strong> (denominada &quot;la Compañía&quot;,
                &quot;Nosotros&quot;, &quot;Nos&quot; o &quot;Nuestro&quot; en
                este Acuerdo) se refiere a Stellar Merge.
              </Text>
            </li>
            <li>
              <Text>
            ...
            <li>
              <Text>
                <strong>Servicio de redes sociales de terceros</strong> se
                refiere a cualquier sitio web o red social a través del cual un
            ...
            <li>
              <Text>
                <strong>Los Datos de uso</strong> se refieren a los datos
                recopilados automáticamente, ya sea generados por el uso del
                Servicio o por la propia infraestructura del Servicio.
              </Text>
            </li>
            <li>
              <Text>
                ...
                de la cual dicha persona accede o utiliza el Servicio.
              </Text>
            </li>
          </TextList>
        </PolicySection>
        ...
        <PolicySection>
          ...
          <TextTertiarySubtitle>Información personal</TextTertiarySubtitle>
          <Text>
            Al utilizar nuestro servicio, podemos pedirle que nos proporcione
            cierta información de identificación personal que pueda usarse para
            contactarlo o identificarlo. La información de identificación
            personal puede incluir, entre otras: dirección de correo electrónico
            y datos de uso.
          </Text>
          <TextTertiarySubtitle>Datos de uso</TextTertiarySubtitle>
          <Text>
          ...
          <Text>
            ...
            su dispositivo, tipo de navegador, versión del navegador, las
            páginas de nuestro Servicio que visita, la hora y fecha de su
            visita, el tiempo dedicado a esas páginas e identificadores únicos
            de dispositivo.
          </Text>
          <TextTertiarySubtitle>
          ...
          <Text>
            ...
            sociales de terceros: Google, Facebook, Instagram, Twitter y
            LinkedIn.
          </Text>
          <TextSecondarySubtitle>
          ...
          <TextList>
            ...
            <li>
              <Text>
                <strong>Para administrar Su Cuenta:</strong> para administrar Su
            ...
            <li>
              <Text>
                ...
                desarrollo, cumplimiento y ejecución del contrato de compra de
                los productos que Usted haya adquirido.
              </Text>
            </li>
            <li>
              <Text>
                <strong>Para contactarlo:</strong> Para contactarlo por correo
                electrónico, llamadas telefónicas, SMS u otras formas de
            ...
            <li>
              <Text>
                ...
                utilizar su información para evaluar o llevar a cabo una fusión,
                desinversión, reestructuración u otra transferencia de activos.
              </Text>
            </li>
          </TextList>
          <TextSecondarySubtitle>
            Conservación y transferencia de sus datos personales
          </TextSecondarySubtitle>
          <Text>
            ...
            privacidad. La Compañía tomará todas las medidas razonablemente
            necesarias para garantizar que Sus datos sean tratados de forma
          ...
          <Text>
            ...
            datos personales que hemos recopilado sobre usted. Puede actualizar,
          ...
          <TextTertiarySubtitle>Transacciones de negocios</TextTertiarySubtitle>
          <Text>
            Si la Compañía está involucrada en una fusión, adquisición o venta
            de activos, sus datos personales pueden ser transferidos. Le
            avisaremos antes de que sus datos personales se transfieran y queden
            sujetos a una política de privacidad diferente.
          </Text>
          <TextTertiarySubtitle>
            Cumplimiento de la ley y otros requisitos legales
          </TextTertiarySubtitle>
          <TextList>
          ...
          <Text>
            ...
            o método de almacenamiento electrónico es 100% seguro. Si bien nos
        ...
        <PolicySection>
          <PolicySectionHeader>
            ...
            <TextSubtitle>Privacidad de los niños</TextSubtitle>
          </PolicySectionHeader>
          <Text>
            Nuestro Servicio no está dirigido a personas menores de 13 años. No
            recopilamos conscientemente información de identificación personal
            de ninguna persona menor de 13 años. Si usted es padre o tutor y
        ...
        <PolicySection>
          ...
          <Text>
            ...
            son operados por Nosotros. Le recomendamos encarecidamente que
            revise la Política de privacidad de cada sitio que visite. No
            tenemos control ni asumimos ninguna responsabilidad por el
        ...
        <PolicySection>
          <PolicySectionHeader>
            ...
            <TextSubtitle>Cambios a esta Política de Privacidad</TextSubtitle>
          </PolicySectionHeader>
          <Text>
            ...
            Privacidad en esta página. Le informaremos por correo electrónico
            y/o un aviso destacado en Nuestro Servicio, antes de que el cambio
            entre en vigencia.
          </Text>
        </PolicySection>
        ...
        <PolicySection>
          <PolicySectionHeader>
            ...
            <TextSubtitle>Contáctenos</TextSubtitle>
          </PolicySectionHeader>
          <Text>
