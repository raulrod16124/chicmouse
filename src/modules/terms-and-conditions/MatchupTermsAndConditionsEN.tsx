...
export const MatchupTermsAndConditionsEN = () => {
  return (
    <TermsAndConditionsWrapper data-testid="matchup-terms-and-conditions-en-page-id">
      <TermsAndConditionsContent>
        ...
        <TextList>
          ...
          <li>
            <Text>
              ...
              in this Agreement) refers to Matchup.
            </Text>
          </li>
          <li>
            <Text>
